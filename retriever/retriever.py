...
if __name__ == "__main__":
    ...
    output_path = os.path.join(subset_output_dir, f"top-{args.top_k}_{model_name}.json")
    ...
    if args.model_name == "bm25":
        ...
        for i in tqdm(range(len(data))):
            ...
            top_k_paragraphs_and_scores = index.search_knn(query_embeddings[i].reshape(1, -1), args.top_k)
